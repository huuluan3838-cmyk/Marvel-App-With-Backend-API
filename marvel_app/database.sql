...
(5, N'Đền Ngọc Sơn', 'https://example.com/ngocson.jpg'),
...
-- thêm các trường lưu trữ mã OTP vào bảng NguoiDung:
ALTER TABLE NguoiDung ADD OtpCode VARCHAR(10) NULL;
ALTER TABLE NguoiDung ADD OtpExpiry DATETIME NULL;

--Tạo bảng lưu FCM token
